...
public class Pperfil extends JFrame {
  ...
  edao = new EventoDao();
		 ...
		 * null}, {null, null, null, null, null}, {null, null, null, null,
		 * null}, {null, null, null, null, null}, {null, null, null, null,
		 * null}, }, new String[] { "Nome", "Data", "Inicio",
		 * "Finaliza\u00E7\u00E3o", "Pontos" } ));
		 */
		...
		label_10.setIcon(new ImageIcon(
				"C:\\Users\\Gabriel Segalla\\git\\se-situacao-aprendizagem-2014-2\\Imagens\\P.ICON.png"));
		...
		label_3.setIcon(new ImageIcon(
				"C:\\Users\\Gabriel Segalla\\git\\se-situacao-aprendizagem-2014-2\\Imagens\\plano de Fundo.jpg"));
